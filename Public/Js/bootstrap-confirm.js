!function( $ ){
	...
	$.fn.confirm.defaults = {
		...
		template : '<div class="modal hide'+($.browser.msie && $.browser.version == '10.0' ? "" : " fade")+' confirm-modal"><div class="modal-header"><h3></h3></div><div class="modal-body"></div><div class="modal-footer"><a href="#" class="btn btn-primary confirm-btn" data-dismiss="modal">确定</a><a href="#" class="btn confirm-cancelbtn" data-dismiss="modal">取消</a></div></div>'
	};
